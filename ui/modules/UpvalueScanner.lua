...
local Base = import("rbxassetid://11896433085").Base -- 11389137937
...
local function generateScriptFormat(elementIndex)
    local generatedScript = [[-- Generated by nilware's Upvalue Scanner: https://github.com/DiscMil/nilware

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/DiscMil/nilware/revision/ohaux.lua"))()
